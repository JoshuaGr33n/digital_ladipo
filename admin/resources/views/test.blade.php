...
<div   style="margin:auto;" width="40%">
    <div class="element-wrapper">
        <h6 class="element-header">Main Categories <button class="mr-2 mb-2 btn btn-warning" type="button" style="margin-left:500px" data-toggle="modal" data-target="#ModalAdd">Add Main Category +</button></h6>
        <div class="element-box">
            <h5 class="form-header">Main Categories</h5>
            <div class="form-desc">
            ...
            <div class="table-responsive">
                <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ ++$i }}</td>
                            <td>{{ ucfirst($categories->main_category) }} </td>
                           {{ $url = str_replace(' ','-',$categories->main_category)}}
                            <td><a href="categories/{{$url}}/second-categories" class="btn btn-primary btn-sm" style="color:#fff">Sub Categories</a> </td>
                          <td>
                                 ...
                                 <form action="" method="POST">
                                  ...
                                  <td> 
                                      <?php 
                                    //   $check_menu_category = DB::select("SELECT * FROM sekai_menu WHERE category like '%$categories->main_category%'");
                                      ?>

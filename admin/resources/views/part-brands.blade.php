...
<div   style="margin:auto;" width="40%">
    <div class="element-wrapper">
        <h6 class="element-header">Part Brands </h6>
        <div class="element-box">
            <h5 class="form-header">Part Brands <button class="mr-2 mb-2 btn btn-success" type="button" style="margin-left:400px" data-toggle="modal" data-target="#ModalAdd">Add Brand+</button></h5>
            <div class="form-desc">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                                 ...
                                 <form action="edit-part-brand/{{ $brand->id }}" method="POST" enctype="multipart/form-data">
                                   {{ csrf_field() }}
                                   {{ method_field('PATCH') }}
                                  ...
                                  <td> 
                                        ...
                                        @php 
                                         $check_products = DB::select("SELECT * FROM products WHERE part_brand_id like '%$brand->id%'");
                                        @endphp
                                      
                                  <form action="delete-part-brand/{{ $brand->id }}" method="POST">
                                  {{-- @csrf
                                   @method('DELETE') --}} 
            ...
            <div class="modal-body">
             ...
             @if ($errors->any())
              ...
              <ul>
               ...
               @endif
                <form  method="POST" action="add-part-brand"  class="btn-submit" id="formValidate" enctype="multipart/form-data">
                {{ csrf_field() }}

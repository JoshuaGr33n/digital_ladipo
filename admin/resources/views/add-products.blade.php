              ...
              {{ csrf_field() }}
                <div class="element-info">
                    <div class="element-info-with-icon">
                        ...
                        <div class="element-info-text">
                            <h5 class="element-inner-header">Add Product</h5>
                ...
                <div class="row">
                 <div class="col-sm-6">
                                ...
                                <div  style="font-size:10px"><span>Dimension</span>: 600 x 600</div>
                ...
                <div class="form-group">
                    <label for=""> Name</label><input class="form-control" data-error="Required" placeholder="" required="required" type="text"  name="name" value="{{ old('name') }}"/>
                    <div class="help-block form-text with-errors form-control-feedback"></div>
                </div>
                <div class="form-group">
                    <label for=""> Main Category</label>
                    <!-- <select class="form-control select2" multiple="true" id='main_cate' name='main_cate[]'> -->
                    <select class="form-control select2"  id='main_cate' name='main_cate[]' data-error="Required" placeholder="" required="required">
                    <option value="">-- Select --</option>
                    @foreach($mainCategoriesData['data'] as $mainCategory)
                    @if(!empty($mainCategory->main_category))
                    <option value='{{ $mainCategory->id }}' data-id="{{ $mainCategory->id }}">{{ucwords($mainCategory->main_category) }} </option>
                    @endif
                    @endforeach
                    </select>
                    <div class="help-block form-text with-errors form-control-feedback"></div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2"  id='second_cate' name='second_cate[]'  data-error="Required" placeholder="">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 "  id='third_cate' name='third_cate[]'  data-error="Required" placeholder="">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                             ...
                             <option value=''>-- Select Car Brand --</option>
                               ...
                               <option value='{{$car_brand->id}}'>{{ucwords($car_brand->name)}}</option>
                               @endforeach
                             </select>
                             <div class="help-block form-text with-errors form-control-feedback"></div>
                        </div>
                       ...
                       <div class="col-sm-6">
                          <div class="form-group">
                             ...
                             <select class="form-control select2" data-error="Required" placeholder="" required="required" name="part_brand">
                               ...
                               <option value='{{$part_brand->id}}'>{{ucwords($part_brand->name)}}</option>
                               @endforeach
                             </select>
                             <div class="help-block form-text with-errors form-control-feedback"></div>
                         </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                        <label for="">Price</label><input class="form-control" data-error="Required" placeholder="" required="required" name="price" value="{{ old('price') }}"/>
                        <div class="help-block form-text with-errors form-control-feedback"></div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                        <label for="">Old Price</label><input class="form-control"  placeholder="" name="old_price" value="{{ old('old_price') }}"/>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                        <label for="">Quantity</label><input class="form-control"  data-error="Required" placeholder="" required="required" name="quantity" value="{{ old('quantity') }}"/>
                        <div class="help-block form-text with-errors form-control-feedback"></div>  
                      </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:200px" name="description" required="required" data-error="Required:: Place a description for this product">{{ old('description') }}</textarea>
                    <div class="help-block form-text with-errors form-control-feedback"></div>
                </div>

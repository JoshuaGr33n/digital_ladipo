            ...
            <form id="formValidate" enctype="multipart/form-data" method="Post" action="{{ asset($Products->id) }}/update">
              {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2"  id='main_cate' name='main_cate[]'>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2"  id='second_cate' name='second_cate[]'>

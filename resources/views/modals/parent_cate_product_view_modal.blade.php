                                        ...
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                                            <div class="modal_tab_img">
                                               @if(!empty($product->pic_1))
                                                <a href="{{url('name/name/name/'.str_replace(' ','-',$mainCat->main_category).'/'.str_replace(' ','-',$secondCat->second_category).'/'.str_replace(' ','-',$product->name))}}"><img src="{{ asset('admin'.$product->pic_1) }}" alt=""></a>
                                                @else
                                                <a href="{{url('name/name/name/'.str_replace(' ','-',$mainCat->main_category).'/'.str_replace(' ','-',$secondCat->second_category).'/'.str_replace(' ','-',$product->name))}}"><img src="{{ asset('public/assets/img/no-img.png') }}" alt=""></a>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab2" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="{{url('name/name/name/'.str_replace(' ','-',$mainCat->main_category).'/'.str_replace(' ','-',$secondCat->second_category).'/'.str_replace(' ','-',$product->name))}}"><img src="{{ asset('admin'.$product->pic_2) }}" alt=""></a>
                                            </div>
                                        </div>
                                ...
                                <div class="modal_right">
                                    ...
                                    <div class="variants_selects">
                                        ...
                                        <div class="modal_add_to_cart">
                                                  ...
                                                  <a href="{{url('name/name/name/'.str_replace(' ','-',$mainCat->main_category).'/'.str_replace(' ','-',$secondCat->second_category).'/'.str_replace(' ','-',$product->name))}}" class="btn btn-success btn-xs" style="margin-bottom:20px">View Product</a>

                                        ...
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                                            <div class="modal_tab_img">
                                               @if(!empty($product->pic_1))
                                                <a href="{{url($link)}}"><img src="{{ asset('admin'.$product->pic_1) }}" alt=""></a>
                                                @else
                                                <a href="{{url($link)}}"><img src="{{ asset('public/assets/img/no-img.png') }}" alt=""></a>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab2" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="{{url($link)}}"><img src="{{ asset('admin'.$product->pic_2) }}" alt=""></a>
                                            </div>
                                        </div>
                                ...
                                <div class="modal_right">
                                    ...
                                    <div class="variants_selects">
                                        ...
                                        <div class="modal_add_to_cart">
                                                ...
                                                <a href="{{url($link)}}" class="btn btn-success btn-xs" style="margin-bottom:20px">View Product</a>
                                                <div class="add">

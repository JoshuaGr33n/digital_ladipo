                        ...
                        @endphp
                                  ...
                                  @if(empty($special_offer->second_category_id) && empty($special_offer->third_category_id))
                                   ...
                                   @else
                                      ...
                                      @endforeach
                                  @endif
   <div class="modal fade color_scheme_2" id="modal_box_special{{$special_offer->id}}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal_body">
                    <div class="container">
                        <span id="status-special-modal"></span>
                        <div class="row">
                                ...
                                <div class="modal_tab">
                                    <div class="tab-content product-details-large">
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                                            <div class="modal_tab_img">
                                               @if(!empty($special_offer->pic_1))
                                                <a href="{{$link}}"><img src="{{ asset('admin'.$special_offer->pic_1) }}" alt=""></a>
                                                @else
                                        ...
                                        <div class="tab-pane fade" id="tab2" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="{{$link}}"><img src="{{ asset('admin'.$special_offer->pic_2) }}" alt=""></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal_tab_button">
                                        <ul class="nav product_navactive owl-carousel" role="tablist">
                                            <li>
                                               @if(!empty($special_offer->pic_1))
                                                <a class="nav-link active" data-toggle="tab" href="#tab1" role="tab" aria-controls="tab1" aria-selected="false"><img src="{{ asset('admin'.$special_offer->pic_1) }}" alt=""></a>
                                              @else
                                            ...
                                            <li>
                                                <a class="nav-link" data-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false"><img src="{{ asset('admin'.$special_offer->pic_2) }}" alt=""></a>
                                            </li>
                                            @endif
                                            <!-- <li>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <div class="modal_right">
                                    ...
                                    <div class="modal_price mb-10">
                                       <span class="{{$price_class}}">₦{{number_format($special_offer->price,2)}}</span>

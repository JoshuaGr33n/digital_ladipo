                                ...
                                <div class="product_d_right">
                                    <form action="#">
                                        ...
                                        <div class="product_meta">
                                            <span>Category: <a href="#">{{ucwords($secondCat->second_category)}}</a></span>
                                        </div>
                        ...
                        <div class="product_carousel product_sidebar_column4 owl-carousel">
                            ...
                            <div class="single_product">
                                <div class="product_name">
                                    <h3><a href="{{url('name/name/name/'.str_replace(' ','-',$mainCat->main_category))}}/{{str_replace(' ','-',$secondCat->second_category)}}/{{str_replace(' ','-',$related_product->name)}}">{{$related_product->name}}</a></h3>
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="{{url('name/name/name/'.str_replace(' ','-',$mainCat->main_category))}}/{{str_replace(' ','-',$secondCat->second_category)}}/{{str_replace(' ','-',$related_product->name)}}">@if(!empty($related_product->pic_1))<img src="{{ asset('admin'.$related_product->pic_1) }}" alt="" style="width:150px; height:150px">@else<img src="{{ asset('public/assets/img/no-img.png') }}" alt="" style="width:150px; height:150px">@endif</a>
                                    <a class="secondary_img" href="{{url('name/name/name/'.str_replace(' ','-',$mainCat->main_category))}}/{{str_replace(' ','-',$secondCat->second_category)}}/{{str_replace(' ','-',$related_product->name)}}">@if(!empty($related_product->pic_2))<img src="{{ asset('admin'.$related_product->pic_2) }}" alt="" style="width:150px; height:150px">@endif</a>
